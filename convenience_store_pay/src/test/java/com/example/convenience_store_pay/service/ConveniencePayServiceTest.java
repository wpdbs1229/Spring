...
import com.example.convenience_store_pay.type.PayCancelResult;
import com.example.convenience_store_pay.type.PayMethodType;
import com.example.convenience_store_pay.type.PayResult;
...
class ConveniencePayServiceTest {
   ...
   void pay_success() {
       //given
        PayRequest payRequest = new PayRequest(PayMethodType.MONEY, ConvenienceType.G24, 50);
    ...
    void pay_fail() {
        //given
        PayRequest payRequest = new PayRequest(PayMethodType.MONEY, ConvenienceType.G24, 1500_001);
    ...
    void pay_cancel_success() {
        //given
        PayCancelRequest payCancelRequest = new PayCancelRequest(PayMethodType.MONEY, ConvenienceType.G24, 1000);
    ...
    void pay_cancel_fail() {
        //given
        PayCancelRequest payCancelRequest = new PayCancelRequest(PayMethodType.MONEY, ConvenienceType.G24, 99);
